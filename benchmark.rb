...
Benchmark.bm do |x|
  x.report("Romeo") { run_repeating_letters2("spec/test_files/romeo.txt") }
  x.report("War and Peace") { run_repeating_letters2("spec/test_files/war_and_peace.txt") }
end
...
RubyProf.start
puts 'updated version - war and peace'
 run_repeating_letters2("spec/test_files/war_and_peace.txt")
result = RubyProf.stop
